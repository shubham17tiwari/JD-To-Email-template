...
export const STATIC_INTRO_PARAGRAPH = `We are seeking a {POSITION_TITLE} for the D.C. Government and thought you might be a good fit.`
...
export const STATIC_BENEFITS_BLOCK = `What's the benefit of working with Hill Technologies?
We connect high-level talent with advantageous opportunities, playing a crucial role in assisting career experts with achieving their goals conveniently.
...
export const STATIC_SIGNATURE = `Hans Capozzi
________________
(202) 650-7790
www.hilltechinc.com
